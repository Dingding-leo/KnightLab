...
- [x] On-demand engine startup, non-Play workspace code splitting/prefetch, single-thread/node-bounded play presets, isolated live-clock repainting, memoized board-square interaction, cached acknowledged UCI options and bot-over-review engine priority
